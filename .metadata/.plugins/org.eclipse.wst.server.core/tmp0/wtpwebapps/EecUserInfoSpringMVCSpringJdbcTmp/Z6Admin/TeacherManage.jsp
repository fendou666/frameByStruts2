...
<script type="text/javascript" src="<%=request.getContextPath() %>/Z6Admin/js/adminOperation.js"></script>
...
<body>
	...
	<div id="d1">
		...
		<div id="d3">
			...
			<div id="d33"><a href="<%=request.getContextPath() %>/adminTeacherChain.action">教师信息查看</a></div>
