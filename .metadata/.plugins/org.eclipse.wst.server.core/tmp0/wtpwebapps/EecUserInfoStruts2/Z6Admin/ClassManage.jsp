...
<body>
	...
	<div id="d1">
		...
		<div id="d4">
			...
			<table id="t1" >
				<tr>
					<td>&nbsp;&nbsp;班级：<input type="text"  name="id" value=""></td>
					<td>&nbsp;&nbsp;班主任：<input type="text" name="name" value=""></td>
					<!-- 默认全部查询 -->
			...
			<table id="t2" border="1">
				<tr bgcolor="#8FBC8F">
					<td>序号</td><td>班级</td><td>班主任</td><td>任课老师</td><td>班长</td>
					<td>描述</td><td colspan="1">操作</td>
				</tr>
				<tr>
