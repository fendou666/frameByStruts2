						...
						<form action="RegistServlet" method="post">
							<table align="center" style="border:3px solid green;font-size:30px">
									<%
										...
										System.out.print("---------------------");
										System.out.print("注册界面收到错误信息："+errMsg+"\n");
										System.out.print("---------------------");
										if(errMsg!=null){
											if(!("").equals(errMsg)){
									...
									<%	
										...
										System.out.print("---------------------");
										System.out.print("注册界面收到提示信息："+text+"\n");
										System.out.print("---------------------");
										if(text!=null){
											if(!("").equals(text)){
									...
									%>	
									<tr><th colspan="2" style="font-size:50px">SeSky学员注册</th></tr>
									<tr>
										<td>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名&nbsp;:</td>
										<td><input type="text" name="user" id="user"  style="background: transparent;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr>
										<td>性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别&nbsp;:</td>
										<td><input type="radio" name="sex" value="男" style="margin-left: 0">男&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="radio" name="sex" value="女">女
										</td>
									</tr>
									<tr>
										<td>年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;龄&nbsp;:</td>
										<td><input type="text" name="age" id="age"  style="background: transparent;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr>
										<td>手&nbsp;机&nbsp;号&nbsp;:</td>
									...
									<tr>
										<td>邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱&nbsp;:</td>
										<td><input type="email" name="mail" id="mail"  style="background: transparent;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<tr>
										<td>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码&nbsp;:</td>
